...
test_that("The region is valid value", {
...
test_that("Plot should use correct x variable.", {
  all_plot <- plot_line_by_date("2021-01-01", "2021-12-31")
